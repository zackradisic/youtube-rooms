...
func (s *Server) getAuthorizationCode(code string) (*AuthToken, error) {
	...
	data := "code=" + code + "&client_id=722724036706041976&client_secret=" + s.authDetails.ClientSecret + "&redirect_uri=" + os.Getenv("DISCORD_REDIRECT_URI_ENCODED") + "&scope=identify&grant_type=authorization_code"
